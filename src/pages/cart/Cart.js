...
import { ADD_TO_CART, CALCULATE_SUTOTAL, CALCULATE_TOTAL_QUANTITY, CLEAR_CART, DECREASE_CART, REMOVE_FROM_CART, SAVE_URL, selectCartItems, selectCartToltalAmount, selectCartToltalQuantity } from '../../redux/slice/cartSlice'
                  ...
                  return (
                    <tr key={id}>
                      ...
                      <td>
                        ...
                        <img src={imageURL} alt={name} style={{ width: '110px' }} />
                      </td>
                      <td>{price}</td>
                      <td>
